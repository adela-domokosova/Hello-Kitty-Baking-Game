...
public class Prostor {
    ...
    private boolean prosel = false;//kontrola pro  proběhnutou akci, která se nemá znova opakovat jestli prosel = true
    ...
    /**Metoda přidává věci (objekty) do prostoru/inventare
    ...
    public String popisVeci(){
        if(!veci.isEmpty()){
            String str1 = "Věci v prostoru : ";
            for(String key : veci.keySet()){
                str1 += key + ", ";
            }
            return str1;
        }else{
            String str2 = "Žádné předměty tu nejsou";
            return str2;
        }

    }

    public boolean jeZdeVec(String vec){
        for(String str : veci.keySet()){
            if(Objects.equals(str, vec)){
                return true;
            }
        }
        return false;
    ...
    public void setJeZamcena() {
        this.jeZamcena = false;
    }
    public boolean isProsel() {
        return this.prosel;
    }
    public void setProselFalse() {
        this.prosel = false;
    }
